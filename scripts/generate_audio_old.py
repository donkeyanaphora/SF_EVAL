...
def synth(
    ...
    if wav.exists():
        return  # already synthesised earlier
    ...
    for attempt in range(RETRIES + 1):
        try:
            ...
            manifest_row = {
                ...
                "index": idx,
                "text": sentence,
                # keep just the raw term strings in the manifest
                "medical_terms": [d["term"] for d in medical_terms],
            }
